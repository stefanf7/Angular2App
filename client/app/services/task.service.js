...
var TaskService = (function () {
    ...
    TaskService.prototype.login = function (username, password) {
    ...
    TaskService.prototype.signup = function (first_name, last_name, email, password) {
        var headers = new http_1.Headers();
        headers.append("Content-Type", 'application/json');
